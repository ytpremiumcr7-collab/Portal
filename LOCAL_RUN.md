...
- Migraciones `0001`–`0019` aplicadas (script dinámico: todos los `db/migrations/*.sql`)
...
```
# Nota: docker-compose aplica dinámicamente TODOS los `db/migrations/*.sql` vía scripts/docker-init-migrate.sh.
